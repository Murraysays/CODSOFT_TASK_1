...
### Data Sources
Titancic Dataset: The primary dataset typically used for this project is the "Titancic-Dataset.csv" file, containing information about individual passengers, such as their age, gender, ticket class, fare, cabin, and whether or not they survived, form Kaggle.
